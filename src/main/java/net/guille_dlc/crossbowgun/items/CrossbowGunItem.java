...
public class CrossbowGunItem extends ProjectileWeaponItem implements Vanishable {
	...
	public CrossbowGunItem(Item.Properties pProperties) {
		super(pProperties);
	}
	...
	private static void shootProjectile(
		...
		if (!pLevel.isClientSide) {
			...
			if (pShooter instanceof CrossbowAttackMob crossbowattackmob) {
				...
				Quaternionf quaternionf = new Quaternionf().setAngleAxis((double)(pProjectileAngle * (float) (Math.PI / 180.0)), vec3.x, vec3.y, vec3.z);
